...
resource "local_file" "registration_private_key_pem" {
  content     = module.acme-reg.registration_private_key_pem
  filename = "${path.module}/registration_private_key_pem.pem"
}